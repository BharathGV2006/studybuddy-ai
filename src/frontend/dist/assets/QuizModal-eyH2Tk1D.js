import { c as createLucideIcon, j as jsxRuntimeExports, S as Slot$1, a as cn, r as reactExports, q as useLayoutEffect2, s as React, t as composeRefs, v as reactDomExports, w as useCallbackRef$1, x as useComposedRefs, y as ReactDOM, X } from "./index-D-Ffb-dF.js";
import { c as cva, B as Button } from "./button-DH7WpwP0.js";
/**
...
function QuizQuestionCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[14px] font-medium text-foreground leading-snug", children: question.question })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-2 ml-7", children: question.options.map((option, idx) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          onMouseEnter: (e) => {
            if (!answered) {
              e.currentTarget.style.borderColor = "oklch(0.62 0.18 270 / 0.5)";
              e.currentTarget.style.color = "oklch(0.95 0.01 260)";
            }
          },
          onMouseLeave: (e) => {
            if (!answered) {
              e.currentTarget.style.borderColor = "oklch(0.28 0.02 260 / 0.6)";
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                style: {
                  borderColor: answered && isCorrect ? "oklch(0.55 0.15 142)" : answered && isSelected && !isCorrect ? "oklch(0.55 0.2 25)" : "oklch(0.35 0.02 260)",
                  color: answered && isCorrect ? "oklch(0.55 0.15 142)" : answered && isSelected && !isCorrect ? "oklch(0.55 0.2 25)" : "oklch(0.55 0.01 260)"
                },
            ...
            answered && isSelected && !isCorrect && /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 15, style: { color: "oklch(0.55 0.2 25)" } })
          ]
        },
        option
      );
...
function QuizModal({ studySet, open, onClose }) {
  const [questionStates, setQuestionStates] = reactExports.useState([]);
  const [quizComplete, setQuizComplete] = reactExports.useState(false);
  const questions = (studySet == null ? void 0 : studySet.quizQuestions) ?? [];
  const initStates = () => questions.map(() => ({
    selectedIndex: null,
    state: "unanswered"
  }));
  ...
  const handleSelect = (qIndex, optionIdx) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      style: {
        ...
        boxShadow: "0 24px 64px oklch(0 0 0 / 0.6), 0 0 0 1px oklch(0.62 0.18 270 / 0.08)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, oklch(0.28 0.1 270), oklch(0.22 0.08 260))",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "radial-gradient(ellipse 60% 80% at 80% 50%, oklch(0.62 0.18 270 / 0.3), transparent)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 15, style: { color: "oklch(0.75 0.15 270)" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-[17px] font-semibold text-foreground leading-snug", children: studySet == null ? void 0 : studySet.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "p",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-5 flex flex-col gap-6 max-h-[60vh] overflow-y-auto", children: questions.map((q, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          QuizQuestionCard,
          {
            question: q,
            qIndex: idx,
            state: questionStates[idx] ?? {
              selectedIndex: null,
              state: "unanswered"
            },
        ...
        quizComplete && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] text-muted-foreground", children: "Score:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Badge,
                  {
                    ...
                    style: {
                      background: score === total ? "oklch(0.35 0.12 142 / 0.2)" : "oklch(0.35 0.1 270 / 0.2)",
                      color: score === total ? "oklch(0.7 0.15 142)" : "oklch(0.75 0.15 270)",
                ...
                score === total && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "text-[12px]",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    onClick: handleReset,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { size: 13, className: "mr-1.5" }),
                      "Retry"
                    ]
                  }
                ),
        ...
        !quizComplete && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
