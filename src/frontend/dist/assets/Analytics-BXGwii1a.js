import { r as reactExports, j as jsxRuntimeExports, g as commonjsGlobal, h as getDefaultExportFromCjs, i as clsx, R as React, k as invariant, d as BookOpen, m as motion, l as mockStudySessions, n as mockAnalyticsSummary } from "./index-D-Ffb-dF.js";
import { C as Clock } from "./clock-CaNC5c_4.js";
import { T as TrendingUp, F as Flame } from "./trending-up-uXbhHKWK.js";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: size, height: size }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              ...
              role: "img",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: `${percentage}% of daily study goal reached` }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center rotate-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-0.5", children: progress >= 1 ? "🎉 Goal reached!" : `${(goal - current).toFixed(1)} ${unit2} remaining` })
        ] })
      ]
    }
  );
...
function buildChartData(sessions) {
  ...
  for (const d2 of days) {
    buckets[d2] = { ai: 0, solo: 0 };
  }
  for (const s2 of sessions) {
    const msTimestamp = Number(s2.startedAt / BigInt(1e6));
    const date2 = new Date(msTimestamp);
    const dayKey = days[date2.getDay()];
    const hrs = Number(s2.durationSeconds) / 3600;
    if (s2.aiAssisted) {
...
function CustomTooltip({ active, payload, label }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground mb-2", children: label }),
        payload.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-2 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function StudyChart({ sessions }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full", "data-ocid": "analytics.study_chart", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 240, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    BarChart,
    {
      data,
      barCategoryGap: "32%",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Legend,
          {
            iconType: "circle",
            iconSize: 8,
            formatter: (value) => value === "ai" ? "AI-Assisted" : "Solo",
            wrapperStyle: {
              fontSize: "12px",
...
function filterSessions(sessions, range3) {
  if (range3 === "all") return sessions;
  const now2 = Date.now();
  const cutoffMs = range3 === "7d" ? 7 * 864e5 : 30 * 864e5;
  return sessions.filter((s2) => {
    const msTimestamp = Number(s2.startedAt / BigInt(1e6));
    return now2 - msTimestamp <= cutoffMs;
  });
}
...
function calcStats(sessions) {
  const total = sessions.reduce((a2, s2) => a2 + Number(s2.durationSeconds), 0);
  const totalHrs = total / 3600;
  const avgSecs = sessions.length ? total / sessions.length : 0;
  const avgMin = Math.round(avgSecs / 60);
  const subjects = new Set(sessions.map((s2) => s2.subject)).size;
  const days = new Set(
    sessions.map((s2) => {
      const ms = Number(s2.startedAt / BigInt(1e6));
  ...
  for (let i = 0; i < 30; i++) {
    ...
    if (days.has(d2.toDateString())) streak++;
    else if (i > 0) break;
  }
  return { totalHrs, avgMin, subjects, streak };
}
function Analytics() {
  const [range3, setRange] = reactExports.useState("7d");
  const filtered = reactExports.useMemo(
    () => filterSessions(mockStudySessions, range3),
    [range3]
  );
  const stats = reactExports.useMemo(() => calcStats(filtered), [filtered]);
  const aiHours = reactExports.useMemo(
    () => toHours(
      filtered.filter((s2) => s2.aiAssisted).reduce((a2, s2) => a2 + s2.durationSeconds, BigInt(0))
    ),
    [filtered]
  );
  const todaySessions = reactExports.useMemo(() => {
    const today = (/* @__PURE__ */ new Date()).toDateString();
    return filtered.filter((s2) => {
      const ms = Number(s2.startedAt / BigInt(1e6));
      return new Date(ms).toDateString() === today;
    });
  }, [filtered]);
  const todayHours = reactExports.useMemo(
    () => toHours(todaySessions.reduce((a2, s2) => a2 + s2.durationSeconds, BigInt(0))),
    [todaySessions]
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-7xl mx-auto space-y-8", "data-ocid": "analytics.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground tracking-tight", children: "Learning Analytics" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1 text-sm", children: "Track your study patterns and optimize performance" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: rangeOptions.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  role: "tab",
                  "aria-selected": range3 === opt.value,
                  "data-ocid": `analytics.filter.${opt.value}`,
                  type: "button",
                  onClick: () => setRange(opt.value),
                  className: [
                    "px-3 py-1.5 rounded-lg text-xs font-medium transition-smooth",
                    range3 === opt.value ? "text-foreground" : "text-muted-foreground hover:text-foreground"
                  ].join(" "),
                  style: range3 === opt.value ? {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: statCards.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            style: card.accent ? { borderColor: "oklch(0.62 0.18 270 / 0.2)" } : {},
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: card.accent ? "oklch(0.62 0.18 270 / 0.15)" : "oklch(0.22 0.02 260)",
                    color: card.accent ? "oklch(0.78 0.14 270)" : "oklch(0.55 0.01 260)",
                    boxShadow: card.accent ? "0 0 12px oklch(0.62 0.18 270 / 0.2)" : "none"
                  },
                  children: card.icon
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mb-1", children: card.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "font-display text-2xl font-bold leading-none",
                    style: {
                      color: card.accent ? "oklch(0.78 0.14 270)" : "oklch(0.95 0.01 260)"
                    },
                    children: card.value
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-1", children: card.sub })
              ] })
            ]
          },
          card.label
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-sm mb-0.5", children: "Today's Progress" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xs font-medium text-muted-foreground uppercase tracking-wider", children: "Session Split (All Time)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "AI-Assisted" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Solo" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
                    totalSoloHours.toFixed(1),
                    "h · ",
                    100 - aiPct,
                    "%"
                  ] })
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-sm mb-0.5", children: "Study Hours by Day" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: "AI-assisted vs solo sessions" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(StudyChart, { sessions: filtered }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: "AI-assisted" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground text-sm font-semibold", children: [
                        (stats.totalHrs - aiHours).toFixed(1),
                        "h"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: "Solo sessions" })
                    ] })
                  ] })
                ]
              }
